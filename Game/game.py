...
def game( ):
    ...
    while( 1 ):
        ...
        contours,hierarchy = cv2.findContours( mask ,cv2.RETR_EXTERNAL ,cv2.CHAIN_APPROX_SIMPLE )#approx is used to change accuracy
        ...
        for i in range( 0, len(contours) ):
            if ( i % 1 == 0 ):
                ...
                if ( w*h > 2500 ):
                    cv2.drawContours( mask ,contours ,i, (255,255,0), 4 )
